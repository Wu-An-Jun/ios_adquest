...
class _InterstitialAdPageState extends State<InterstitialAdPage> {
  final TextEditingController _adspotIdController =
      TextEditingController(text: '10007791');
  String? _result;
  String? _error;
  bool _isLoading = false;

  Future<void> _playInterstitialAd() async {
    setState(() {
      _isLoading = true;
      _result = null;
      _error = null;
    ...
    try {
      final res = await IosAdquest().showInterstitialAd(_adspotIdController.text);
      setState(() {
        _result = res ?? '无返回结果';
      });
    } catch (e) {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isLoading ? null : _playInterstitialAd,
                  child: _isLoading
                      ? const SizedBox(
                          width: 20,
                          height: 20,
